...
/*   Updated: 2021/11/11 14:01:29 by thakala          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	*segver = 1;
	...
	if (ft_test("abcdefBghijklmnopq")
		...
		|| memcpy(NULL, NULL, 10) != ft_memcpy(NULL, NULL, 10)
		|| memcpy(NULL, "src", 0) != ft_memcpy(NULL, "src", 0)
		|| memcpy(NULL, "src", 3) != ft_memcpy(NULL, "src", 3)
		|| memcpy(std_dst, NULL, 0) != ft_memcpy(ft_dst, NULL, 0)
		|| memcpy(std_dst, NULL, 3) != ft_memcpy(ft_dst, NULL, 3))
	{
		printf("KO: ft_memcpy");
		return (1);
	}
